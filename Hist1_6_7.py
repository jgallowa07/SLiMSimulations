...
layout = go.Layout(
    title='indiv-based metrics of realized genetic architecture p2',
    xaxis=dict(
        title='# Mutations'
    ),
    yaxis=dict(
...
py.iplot(fig, filename='indiv-based metrics of realized genetic architecture p2')
